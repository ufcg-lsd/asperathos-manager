...
class TestKubeJobsPlugin(unittest.TestCase):
    ...
    def test_start_stop_application(self):
        ...
        with requests_mock.Mocker() as m:
            ...
            m.post("http://0.0.0.0:5001/monitoring/%s" % self.job1.app_id, text="")
            m.put("http://0.0.0.0:5001/monitoring/%s/stop" % self.job1.app_id, text="")
    ...
    def test_terminate_job(self):
        ...
        with requests_mock.Mocker() as m:
            ...
            m.post("http://0.0.0.0:5001/monitoring/%s" % self.job2.app_id, text="")
...
class TestKubeJobsProvider(unittest.TestCase):
    ...
    def test_get_description(self):
        self.assertEqual(self.provider1.get_description(), 
    ...
    def test_to_dict(self):
        ...
        self.assertEqual(to_dict.get("title"), 
                                    "Kubernetes Batch Jobs Plugin")
        self.assertEqual(to_dict.get("description"),
        'Plugin that allows utilization of Batch Jobs over a k8s cluster')
